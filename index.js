...
module.exports = stream =>
    fromStream(stream)
        ...
        .subscribe(data => {
            ...
            cummulativeCountTimeout
                .labels(name)
                .inc(data.countTimeoutDeriv || 0);
            cummulativeRequestCount
                .labels(name)
                .inc(data.countTotalDeriv || 0);
            cummulativeCountFailure
                .labels(name)
                .inc(data.countFailureDeriv || 0);
            cummulativeCountShortCircuited
                .labels(name)
                .inc(data.countShortCircuitedDeriv || 0);
            cummulativeCountSuccess
                .labels(name)
                .inc(data.countSuccessDeriv || 0);
