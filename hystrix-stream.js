...
const rollingCountCollapsedRequests = new Gauge('hystrix_collapsed_requests_total', 'Total number of times a requests has been collapsed.',
  ['breakerName']);
...
const rollingCountFallbackSuccess = new Gauge('hystrix_fallback_successes_total', 'Total number of times a fallback has been successful.',
  ['breakerName']);
const rollingCountResponsesFromCache = new Gauge('hystrix_responses_from_cache_total',
  'Total number of times a response has been returned from the cache.', ['breakerName']);
const rollingCountSemaphoreRejected = new Gauge('hystrix_semaphore_rejections_total',
  'Total number of times a request failed because of empty semaphore.', ['breakerName']);
...
const rollingCountThreadPoolRejected = new Gauge('hystrix_thread_pool_rejections_total',
  'Total number of times a the thread pool rejected.', ['breakerName']);
const rollingCountTimeout = new Gauge('hystrix_timeouts_total', 'Total number of times a request timed out.', ['breakerName']);
const currentConcurrentExecutionCount = new Gauge('hystrix_current_concurrent_executions_total',
  'Total number of requests going concurrently.', ['breakerName']);
...
export default stream => fromStream(stream)
